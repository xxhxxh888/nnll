...
class SASCTS(SequentialRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        self.nns_sim=Similarity(0.05)#pptt!!
    ...
    def forward(self, item_seq, item_seq_len):
        ...
        if USE_TOKEN_SHUFFLE and is_train:#pptt!!
        ...
        if USE_ADD_NOISE and is_train:#pptt!!
        ...
        output_l2 = trm_output[-2]
        output_l2 = self.gather_indexes(output_l2, item_seq_len - 1)
    ...
    def calculate_loss(self, interaction):
        ...
        seq_output,seq_output_l2 = self.forward(item_seq, item_seq_len)  # N * D  #pptt!!
        ...
        if self.config['aug'] == 'self':
            cts_seq_output,cts_seq_output_l2 = self.forward(item_seq, item_seq_len)#pptt!!
            if USE_PRJ_HEAD:
        ...
        cts_nce_logits_l2, cts_nce_labels_l2 = self.cts_loss(raw_seq_output_l2, cts_seq_output_l2, temp=1.0,
                                                        batch_size=item_seq_len.shape[0])
        nce_loss_l2 = self.loss_fct(cts_nce_logits_l2, cts_nce_labels_l2)
        ...
        if True:
            ...
            for _ in range(4): # (cls.model_args.pgd):#!!!!!!!!!
